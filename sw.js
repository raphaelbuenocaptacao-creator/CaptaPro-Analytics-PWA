const CACHE = "captaup-v14-android2";
const APP_SHELL = ["./index.html", "./manifest.webmanifest", "./icon.svg", "./captaup.css", "./captaup-data.js", "./captaup-main.js", "./captaup-pwa.js", "./data-2026-full.json", "./data-2026-full.part1.txt", "./data-2026-full.part2.txt", "./data-2026-full.part3.txt", "./data-2026-full.part4.txt", "./vendor/pako.part1.txt", "./vendor/pako.part2.txt", "./vendor/pako.part3.txt"];
